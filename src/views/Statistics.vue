      ...
      <div>
        <article id="main">
          ...
          <section>
            <article>
              ...
              <section>
                <table>
                  ...
                  <tr>
                    <td>Nombre total de partage</td>
                    <td>{{ stats["nb_share"] }}</td>
                  </tr>
                  <tr>
                    <td>Moyenne d'utilisation par jours</td>
                    <td>{{ stats["avg_usage_day"] }}</td>
                  </tr>
                  <tr>
                    <td>Moyenne d'utilisation sur les 7 derniers jours</td>
            ...
            <article>
              <h3>Moyenne d'utilisation sur le mois</h3>
              <div>
            ...
            <article>
              <h3>Moyenne d'utilisation par jours</h3>
              <div>
            ...
            <article>
              <h3>Moyenne d'utilisation par heures</h3>
              <div>
