...
function userInfo() {
  return axios.get(api_url + "/userinfo", headers()).then((response) => {
...
function getAdmin(admin_id) {
  return axios
    .get(api_url + "/admins/" + admin_id.toString(), headers())
    .then((response) => {
      return response["data"];
    });
}
...
function deleteAdmin(admin_id) {
  return axios
    .delete(api_url + "/admins/" + admin_id.toString(), headers())
    .then((response) => {
      return response["data"];
    });
}
...
function getUser(user_id) {
  return axios
    .get(api_url + "/users/" + user_id.toString(), headers())
    .then((response) => {
      return response["data"];
    });
}
...
function deleteUser(user_id) {
  return axios
    .delete(api_url + "/users/" + user_id.toString(), headers())
    .then((response) => {
      return response["data"];
    });
}
...
function deleteUsers(users) {
  return axios
    .put(api_url + "/users/delete", { users: users }, headers())
    .then((response) => {
      return response["data"];
    });
}
...
function getEmail(email_id) {
  return axios
    .get(api_url + "/emails/" + email_id.toString(), headers())
    .then((response) => {
      return response["data"];
    });
}
...
function deleteEmail(email_id) {
  return axios
    .delete(api_url + "/emails/" + email_id.toString(), headers())
    .then((response) => {
      return response["data"];
    });
}
...
function getGlobalStats() {
  return axios.get(api_url + "/statistics", headers()).then((response) => {
    return response["data"];
  });
}
...
function getAvgUsageMonth() {
  return axios
    .get(api_url + "/statistics/avg-usage-month", headers())
    .then((response) => {
      return response["data"];
    });
}
...
function getAvgUsageDay() {
  return axios
    .get(api_url + "/statistics/avg-usage-day", headers())
    .then((response) => {
      return response["data"];
    });
}
...
function getAvgUsageHour() {
  return axios
    .get(api_url + "/statistics/avg-usage-hour", headers())
    .then((response) => {
      return response["data"];
    });
}
